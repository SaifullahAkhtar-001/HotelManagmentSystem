<x-app-layout>
    <div class="max-w-7xl  mx-auto">
        ...
        <form method="POST" action="{{route('hotel.update', $hotel->id)}}" class="max-w-4xl">
            ...
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-5">Create Hotel</button>
        </form>
