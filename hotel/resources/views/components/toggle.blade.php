<div>
<label class="font-semibold text-gray-500 block pb-2">Status</label>
<label class="relative inline-flex items-center cursor-pointer">
    <input type="checkbox" name="active" value="" class="sr-only peer" {{$checker}}>
    <div
    ...
    <span class="ms-3 text-sm font-medium text-gray-500">Active</span>
</label>
</div>
