...
<tr class="hover:bg-gray-50">
    ...
    <th class="flex gap-4">
        ...
        <a class="text-white bg-gray-500/50 hover:bg-gray-400 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none" href="{{route('admin.users.permissions',$user->id)}}">
            Permissions
        </a>
    </th>
    <td class="px-6 py-4">
