@if($website_settings->booking_filter_layout == '1')
    <div class="p-14 w-full bg-stone-800 bg-opacity-70 flex justify-center items-center">
        <form>
            <div class="flex gap-4 mx-auto max-w-fit ">
                ...
                <div>
                    <button type="submit"
                            class="text-white button-color focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-12 py-3  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Search Room
                    </button>
                </div>
            </div>
