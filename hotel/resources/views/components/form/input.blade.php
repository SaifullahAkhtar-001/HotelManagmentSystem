<div {{ $attributes->merge(['class' => 'relative z-0']) }}>
    <input type="{{$type}}" id="floating_standard"
           class="block py-2.5 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 @error($name) focus:border-red-600 @enderror focus:border-blue-600 peer"
