...
<article
    ...
    <div class="max-h-[28rem] overflow-hidden">
        <img draggable="false" class="rounded-xl h-[28rem] w-full transform duration-300 group-hover:scale-110" src="{{ $image }}" alt="">
    </div>
    <div class="mx-4">
        ...
        <h2 class="font-light line-clamp-3">{{ $description }}
        </h2>
